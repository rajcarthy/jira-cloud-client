...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-12-30T18:52:18.038445-08:00[America/Los_Angeles]")@Component("com.atlassian.jira.rest.client.api.WorkflowsApi")
public class WorkflowsApi {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public PageBeanWorkflow getWorkflowsPaginated(Long startAt, Integer maxResults, List<String> workflowName, String expand) throws RestClientException {
        Object postBody = null;
