...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2020-12-30T18:52:18.038445-08:00[America/Los_Angeles]")@Component("com.atlassian.jira.rest.client.api.ProjectKeyAndNameValidationApi")
public class ProjectKeyAndNameValidationApi {
    ...
    public String getValidProjectKey(String key) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/rest/api/3/projectvalidate/validProjectKey").build().toUriString();
    ...
    public String getValidProjectName(String name) throws RestClientException {
        ...
        if (name == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'name' when calling getValidProjectName");
        }
        String path = UriComponentsBuilder.fromPath("/rest/api/3/projectvalidate/validProjectName").build().toUriString();
